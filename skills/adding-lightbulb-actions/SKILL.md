...
- Diagnostic squiggles and warnings → taggers (see [vs-editor-tagger](../creating-editor-taggers/SKILL.md))
- Hover tooltips with information → Quick Info (see [vs-editor-quickinfo](../adding-quickinfo-tooltips/SKILL.md))
- Errors surfaced in the Error List → [vs-error-list](../integrating-error-list/SKILL.md)
