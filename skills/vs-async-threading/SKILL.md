...
Always install the **Microsoft.VisualStudio.Threading.Analyzers** NuGet package in every VS extension project. It catches threading mistakes at compile time.
