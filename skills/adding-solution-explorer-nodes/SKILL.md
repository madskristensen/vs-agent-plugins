...
- Query or select existing projects/files in Solution Explorer → [vs-solution-explorer](../interacting-solution-explorer/SKILL.md)
- Add context menu actions on existing nodes → [vs-context-menu](../adding-context-menus/SKILL.md)
- Show extension-specific content in a separate panel → [vs-tool-window](../adding-tool-windows/SKILL.md)
