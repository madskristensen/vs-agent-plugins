...
- Detailed log output (build log, analysis trace) → Output Window (see [vs-error-handling](../handling-extension-errors/SKILL.md))
- Non-blocking notification (info, update available) → info bar (see [vs-info-bar](../showing-info-bars/SKILL.md))
- Diagnostic squiggles inline in the editor → tagger (see [vs-editor-tagger](../creating-editor-taggers/SKILL.md))
- Light bulb quick fix for a diagnostic → [vs-editor-lightbulb](../adding-lightbulb-actions/SKILL.md)
