...
- Hover tooltips on arbitrary text spans → Quick Info (see [vs-editor-quickinfo](../adding-quickinfo-tooltips/SKILL.md))
- Inline visual decorations (highlights, icons, overlays) → adornments (see [vs-editor-adornment](../adding-editor-adornments/SKILL.md))
- Actionable suggestions (lightbulb) → suggested actions (see [vs-editor-suggested-actions](../adding-suggested-actions/SKILL.md))
