...
- One-shot status update ("operation completed") → status bar message (see [vs-message-box](../showing-message-boxes/SKILL.md))
- Blocking confirmation before or after an operation → message box (see [vs-message-box](../showing-message-boxes/SKILL.md))
- Non-blocking notification that persists → info bar (see [vs-info-bar](../showing-info-bars/SKILL.md))
- Error or warning to surface in the Error List → [vs-error-list](../integrating-error-list/SKILL.md)
