...
- Matching your WPF UI to the current VS theme (Light/Dark/HC) → [vs-theming](../theming-extension-ui/SKILL.md)
- Syntax coloring via classification types → [vs-editor-classifier](../adding-editor-classifiers/SKILL.md) (classifications auto-appear in Fonts & Colors)
- Extension settings beyond colors (booleans, strings, enums) → [vs-options-settings](../adding-options-settings/SKILL.md)
