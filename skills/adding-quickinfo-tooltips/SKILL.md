---
name: adding-quickinfo-tooltips
...
- Auto-complete suggestions → completion (see [vs-editor-completion](../adding-intellisense-completion/SKILL.md))
- Actionable suggestions (lightbulb) → suggested actions (see [vs-editor-lightbulb](../adding-lightbulb-actions/SKILL.md))
- Inline metadata above code elements → CodeLens (see [vs-codelens](../adding-codelens-indicators/SKILL.md))
- Full language support (hover + completion + diagnostics) → LSP (see [vs-language-server](../integrating-language-servers/SKILL.md))
