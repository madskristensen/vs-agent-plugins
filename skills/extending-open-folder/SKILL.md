...
- Full language support (completion, diagnostics, navigation) → [vs-language-server](../integrating-language-servers/SKILL.md) (works alongside Open Folder)
- Adding context menu actions in Solution Explorer for project files → [vs-context-menu](../adding-context-menus/SKILL.md)
- Reacting to solution/project open/close events → [vs-solution-events](../handling-solution-events/SKILL.md)
