...
- Visual overlays on top of text (highlights, inline decorations) → adornments (see [vs-editor-adornment](../adding-editor-adornments/SKILL.md))
- Inline metadata above code elements → CodeLens (see [vs-codelens](../adding-codelens-indicators/SKILL.md))
- A full dockable panel (not attached to the editor) → tool window (see [vs-tool-window](../adding-tool-windows/SKILL.md))
