...
- React to file save/close without intercepting the command → [vs-file-document-ops](../managing-files-documents/SKILL.md)
- React to build start/completion → [vs-build-events](../handling-build-events/SKILL.md)
- Add a new command (not intercept an existing one) → [vs-commands](../adding-commands/SKILL.md)
- Control when commands are visible or enabled → [vs-command-visibility](../controlling-command-visibility/SKILL.md)
